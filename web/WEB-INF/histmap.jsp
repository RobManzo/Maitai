...
<html>
    ...
    <head>
        ...
        <title>Maitai - Storico Prenotazioni</title>
    ...
    <body>
        ...
        <div class="page-section row fill-window" id="bookings" style="background-color: antiquewhite; align-content: flex-start;"> </div>

        <div class="modal fade" id="infobook"> </div>
        <div class="modal fade" id="delbook"> </div>
        ...
        <script src="/Maitai/js/histmap.js"></script>
